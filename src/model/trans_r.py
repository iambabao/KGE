...
class TransR:
    def __init__(self, config):
        ...
        self.projection_layer = tf.keras.layers.Dense(self.relation_em_size, use_bias=False, name='projection_layer')
    ...
    def forward(self):
        # embedding
        pos_s_em, pos_p_em, pos_o_em, neg_s_em, neg_p_em, neg_o_em = self.embedding_layer()

        # projection
        pos_s_em = self.projection_layer(pos_s_em)
        pos_o_em = self.projection_layer(pos_o_em)
    ...
    def embedding_layer(self):
        ...
        return pos_s_em, pos_p_em, pos_o_em, neg_s_em, neg_p_em, neg_o_em
    ...
    def get_constrain_loss(self):
        ...
        projected_s_em = self.projection_layer(s_em)
        projected_o_em = self.projection_layer(o_em)
